...
contract NftMarketplace is ReentrancyGuard {
    ...
    /// @notice NFT contract address -> NFT tokenID -> Listing
    mapping(address => mapping(uint256 => Listing)) private s_listings;

    /// @notice Seller address -> Amount earned
    ...
    function listItem(
        ...
        // Hint: use chainlink price feed to convert the price token of each other
        ...
        nonReentrant
    {
        ...
        // We dont just send money to the user
